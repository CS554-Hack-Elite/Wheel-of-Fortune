...
export const BusinessAdminDashboard = () => {
    ...
    if (status === 1) {
      ...
      return (
        <span className="lg:flex md:hidden ml-auto text-md font-medium w-full">
          <div className="px-3 py-2 mr-4 bg-emerald-700 text-white text-lg rounded-lg w-full text-center hover:cursor-default">
            Approved
          </div>
        </span>
      );
  ...
  const buildRequestCard = (request) => {
    ...
    return (
      <li
        key={request._id}
        className="bg-indigo-800 rounded-lg my-3 px-2 py-4 flex items-center"
      >
  ...
  const buildCouponCard = (coupon) => {
    return (
      <li
        key={coupon._id}
        className="bg-indigo-700 rounded-lg my-3 px-2 py-4 flex items-center"
      >
        <div className="w-14 h-14">
          ...
          <div className="p-4 grid md:grid-cols-4 grid-cols-1 gap-4">
            <div className="md:col-span-2 p-4 lg:h-[80vh] h-[50vh] rounded-lg bg-white bg-opacity-40 overflow-y-auto">
              <div className="flex justify-between items-center">
                <div className="text-3xl font-medium text-indigo-600 p-2">
                  Available Coupons
                </div>
                <div
              ...
              {couponsNotFound ? (
                <div class="text-xl text-indigo-600 p-2">Not Found</div>
              ) : (
                renderCoupons()
              )}
            </div>
