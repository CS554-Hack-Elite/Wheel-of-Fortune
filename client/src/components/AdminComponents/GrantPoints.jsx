...
export const GrantPoints = ({ requestDetails, setOpenModal }) => {
	...
	return (
		<div className="flex justify-center h-full">
			...
			<div className="bg-white flex flex-col w-full md:py-8 my-auto justify-center items-center rounded-lg">
				<div className="text-gray-900 text-lg mb-1 font-medium title-font">Grant Points to {requestDetails.customer_name}</div>
				...
				{status === "approve" ? (
					<div className=" flex flex-col items-center justify-center w-full">
						<FormInput title="Choose between 1-5 Points" type="number" value={points} changeAction={setPoints} />
