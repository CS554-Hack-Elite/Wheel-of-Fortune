...

{
  /* <div>
                ...
                <div class="bg-yellow-100 rounded-lg p-5">
                  ...
                  <div class="pl-4">
                    <p class="text-gray-800 font-bold">qeweqwe</p>
                    <p class="text-gray-400 text-sm">qewewq</p>
                  </div>
                  <p class="lg:flex md:hidden absolute right-6 text-md font-medium">
                    <a href="/sales/inquirydetails/{{_id}}">
                      <button class="px-3 py-2 bg-emerald-600 text-white text-lg rounded-lg hover:bg-emerald-700 active:bg-emerald-500">
                        Details
                      </button>
                    </a>
                  </p>
