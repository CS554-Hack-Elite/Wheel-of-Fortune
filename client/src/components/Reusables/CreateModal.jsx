...
export const CreateModal = ({ openModal, setOpenModal, children }) => {
	return (
		<div className={` z-10 fixed inset-0 bg-gray-500 bg-opacity-75 ${openModal ? "" : "hidden"}`}>
			<div className="flex items-center justify-center h-full">
				<div className="max-h-full flex flex-col rounded-lg w-1/2 p-6 shadow-2xl bg-white">
